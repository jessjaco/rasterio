...
class AzureSession(Session):
    ...
    def __init__(self, azure_storage_connection_string=None,
                 ...
                 azure_unsigned=False, azure_tenant_id=None, azure_client_id=None,
                 azure_federated_token_file=None, azure_authority_host=None):
        ...
        if azure_storage_connection_string:
            ...
            self._creds = {
                ...
                "azure_client_id": self.tenant_id,
                "azure_federated_token_file": self.federated_token_file,
                "azure_authority_host": self.authority_host,
            }
        else:
            self._creds = {
                "azure_storage_account": self.storage_account
    ...
    def hascreds(cls, config):
        ...
        return (
            ...
            or ('AZURE_CLIENT_ID' in config and 'AZURE_TENANT_ID' in config and
                'AZURE_FEDERATED_TOKEN_FILE' in config and 'AZURE_AUTHORITY_HOST' in config)
        )
